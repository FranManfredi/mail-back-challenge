...
router.get("/stats", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ftoken, token, error_1, decodedToken, _a, _b;
    var _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 5:
                decodedToken = (_d = (_e.sent())) !== null && _d !== void 0 ? _d : { role: "USER", username: "" };
                if (decodedToken.role !== "ADMIN") {
                    return [2 /*return*/, res.status(403).send("Invalid role")];
                }
                _b = (_a = res.status(200)).send;
                return [4 /*yield*/, (0, prismaClient_js_1.getStats)()];
            case 6: return [2 /*return*/, _b.apply(_a, [_e.sent()])];
        }
    });
}); });
